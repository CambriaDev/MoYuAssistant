...
func (m *ExcelSplitModule) Description() string {
	return i18n.T("按Sheet页拆分Excel文件", "Split Excel file by sheets")
}
...
func (m *ExcelSplitModule) CreateUI(w fyne.Window) fyne.CanvasObject {
	...
	sizedHeader := module.CreateHeader("MassUpload", i18n.T("Excel Format Converter", "Excel Format Converter"))
